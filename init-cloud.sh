...
log "dp::hermes::hermes_net_cloud::(busy):: Preparing Claudia: Consolidating files."
sed -i "\$a\$'host' => '$HERMES_CLOUD_DB_REDIS'" cloud/data/cloud/config/config.php
sed -i "\$a\$'htaccess.RewriteBase' => '$HERMES_CLOUD_BASEPATH'" cloud/data/cloud/config/config.php
