...
log "dp::hermes::${HERMES_ENV}::ingress::(busy)::preparing Weagle (Ingress: Traefik, Grafana, Prometheus) configuration files." 2
...
log "dp::hermes::${HERMES_ENV}::ingress::(idle)::all good." 0
